...
let tests =
  [("Test01",(string)v1,"[1,1,1]");
   ...
   ("Test13",(string)(System.Math.Round(Vector.dotProduct v1 v2,3)),"-4.375");
   ("Test14",(string)(Vector.crossProduct v1 v2),"[1,-4,3]");
   ("Test15",(string)(Vector.round (Vector.normalise v2) 3),"[-0.457,0.457,0.762]")
   ]
